...
def main():
    ...
    parser.add_argument('--batch-size','-bs',default=256,type=int,help="batch size for training")
    parser.add_argument('--max-grad-norm',default=1,type=float,help="gradient clipping")
    parser.add_argument('--weighted','-w',action="store_true",help="whether consider cluster size in sampling")
    parser.add_argument('--min-cluster-size','-mcs', type=int, default=5, help="minimal size of a cluster")
    ...
    train_set = RNASet(args.train_sequence,args.train_group, 254, args.weighted, args.min_cluster_size)
